...
public class EmbyRepositoryImpl implements IEmbyRepository {
    ...
    @Override
    public List<BaseItemDto> getItemsByParentId(String parentID, Integer startIndex, Integer limit, boolean recursive, String includeItemTypes) {
        try {
